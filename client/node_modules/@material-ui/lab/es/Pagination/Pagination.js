...
const Pagination = React.forwardRef(function Pagination(props, ref) {
  ...
  const {
    ...
    renderItem = item => React.createElement(PaginationItem, item),
    shape = 'round',
    ...
    variant = 'text'
        ...
        other = _objectWithoutPropertiesLoose(props, ["boundaryCount", "children", "classes", "className", "color", "count", "defaultPage", "disabled", "getItemAriaLabel", "hideNextButton", "hidePrevButton", "renderItem", "shape", "showFirstButton", "showLastButton", "siblingCount", "size", "variant"]);
  ...
  }, children || items.map((item, index) => React.createElement("li", {
    key: index
