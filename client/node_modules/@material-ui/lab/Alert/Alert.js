...
var defaultIconMapping = {
  success: React.createElement(_SuccessOutlined.default, {
    fontSize: "inherit"
  }),
  warning: React.createElement(_ReportProblemOutlined.default, {
    fontSize: "inherit"
  }),
  error: React.createElement(_ErrorOutline.default, {
    fontSize: "inherit"
  }),
  info: React.createElement(_InfoOutlined.default, {
    fontSize: "inherit"
  })
};
...
var Alert = React.forwardRef(function Alert(props, ref) {
  ...
  return React.createElement(_Paper.default, (0, _extends2.default)({
    role: role,
    square: true,
    elevation: 0,
