...
<head>
  ...
  <title>Reset Your Maldives Converter Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding: 0'><span style="text-transform:uppercase">Your</span></h1>
 ...
 padding: 0'><span style="text-transform:uppercase">Secret code is :</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
                                                                padding-bottom: 9px; padding-left: 18px;' valign="top"><h1>` + '{secretCode}' + `</h1>
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
